...
function validation() {
  ...
  if (
    ...
    result.innerHTML = `<div id="page" class="position-absolute top-50 start-50 translate-middle">
             <div id="container">
              <div id="ring"></div>
              <div id="ring"></div>
              <div id="ring"></div>
    ...
    if (nama_pelanggan == "") {
      error_nama.textContent =
        "Error: Nama tidak boleh kosong! nama tidak boleh melebihi 30 karakter";
      icon_nama.innerHTML =
